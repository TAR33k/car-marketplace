...
namespace RS1_2024_25.API.Migrations
{
    ...
    [Migration("20250217144851_user-settings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RS1_2024_25.API.Data.Models.Settings", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RS1_2024_25.API.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RS1_2024_25.API.Models.ChatMessage", b =>
                {
                    b.HasOne("RS1_2024_25.API.Data.Models.Auth.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("RS1_2024_25.API.Data.Models.Auth.User", "Sender")
                        .WithMany()
